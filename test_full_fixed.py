"""Test the complete resume upload and infer flow after fixes."""
...
# Test infer target role (should use fallback now)
print('\n=== Testing infer-target-role ===')
start = time.time()
...
try:
    ...
    print(f'Infer SUCCESS in {elapsed:.1f}s:', result)
except urllib.error.HTTPError as e:
    body = e.read().decode()
